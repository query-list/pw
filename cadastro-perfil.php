					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="<?php echo $_SESSION["Nome"]; ?>" data-lock-email="<?php echo $_SESSION["Email"]; ?>">
								...
								<span class="role"><?php echo $_SESSION["Cargo"]; ?></span>
							</div>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Dados do Perfil</span></li>
							</ol>
											...
											<div class="widget-summary">
												<div class="widget-summary-col">
													<div class="summary">
														...
														<form method="POST" enctype="multipart/form-data" action="db-cadastro-perfil.php">
														  <div class="form-group">
															<label for="foto">Imagem do Perfil: </label>
