...
<html class="fixed">
	<head>
		...
		<title>QueryList - Cadastrar Grupos de Emergência</title>
					...
					<div class="row">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Grupos Cadastrados</h2>
							</header>
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<?php
											$varid = $_SESSION["ID"];
											$sql = "SELECT * FROM grupos WHERE id_categoria = '0' ORDER BY id ASC;";
										...
										<div class="panel-body">
											<div class="widget-summary">
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Cadastrar novo grupo</h4>

														<form method="POST" action="db-cadastro-grupos-emergencia.php">
									...
									<section class="panel panel-featured-left panel-featured-primary">
										<div class="panel-body">
											<div class="widget-summary">
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Deletar grupo</h4>

														<form method="POST" action="db-deletar-grupos.php">
														  <div class="form-group">
															<label for="nome">Escolha o Grupo: </label>
																<select class="form-control input-lg" name="id_del">
																	<option value="A">Escolha o grupo...</option>
																	<?php
																		$idcriador = $_SESSION["ID"];
																		$sql = "SELECT * FROM grupos WHERE id_criador = '$idcriador' AND id_categoria = '0' ORDER BY nome_grupo ASC";
																		$res = mysqlexecuta($con,$sql);
																		while($row = mysqli_fetch_assoc($res)){
