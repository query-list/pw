...
<html class="fixed">
	<head>
		...
		<title>QueryList - Cadastrar Contato Emergência</title>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<?php
											$varid = $_SESSION["ID"];
											$sql = "SELECT * FROM contatos WHERE id_categoria = '0'";
										...
										<div class="panel-body">
											<div class="widget-summary">
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Cadastrar Novo Contato de Emergência</h4>

														<form method="POST" action="db-cadastro-contatos-emeregencia.php">
														  ...
														  <div class="form-group">
															...
															<select class="form-control input-lg" name="grupo">
																...
																<?php
																	...
																	$sql = "SELECT * FROM grupos WHERE id_categoria = '0' ORDER BY nome_grupo ASC";
																	$res = mysqlexecuta($con,$sql);
																	while($row = mysqli_fetch_assoc($res)){
															...
															<label for="nome">Escolha o Contato: </label>
																<select class="form-control input-lg" name="id_del">
																	...
																	<?php
																		...
																		$sql = "SELECT * FROM contatos WHERE id_criador = '$idcriador'  AND id_categoria = '0' ORDER BY nome ASC";
																		$res = mysqlexecuta($con,$sql);
																		while($row = mysqli_fetch_assoc($res)){
