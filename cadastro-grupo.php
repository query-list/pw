...
<html class="fixed">
	<head>
		...
		<title>QueryList - Cadastrar Grupos</title>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<?php
											$varid = $_SESSION["ID"];
											$sql = "SELECT * FROM grupos WHERE id_criador = '$varid' AND id_categoria = '1' ORDER BY id ASC;";
											...
											<div class="widget-summary">
												<div class="widget-summary-col">
													<div class="summary">
														...
														<form method="POST" action="db-cadastro-grupos.php">
															...
															<label for="nome">Escolha o Grupo: </label>
																<select class="form-control input-lg" name="id_del">
																	...
																	<?php
																		...
																		$sql = "SELECT * FROM grupos WHERE id_criador = '$idcriador' AND id_categoria = '1' ORDER BY nome_grupo ASC";
																		$res = mysqlexecuta($con,$sql);
																		while($row = mysqli_fetch_assoc($res)){
